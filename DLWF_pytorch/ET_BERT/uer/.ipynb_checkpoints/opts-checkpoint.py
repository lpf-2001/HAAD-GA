...
def infer_opts(parser):
    ...
    parser.add_argument("--spm_model_path", default=None, type=str,
                        help="Path of the sentence piece model.")
    parser.add_argument("--test_path", default=work_dir+"/../datasets/cstnet-tls1.3/packet/nolabel_test_dataset.tsv",type=str, 
                        help="Path of the testset.")
    parser.add_argument("--prediction_path",default=work_dir+"/../datasets/cstnet-tls1.3/packet/prediction.tsv", type=str,
                        help="Path of the prediction file.")
    parser.add_argument("--config_path", default=work_dir+"/../models/bert/base_config.json", type=str,
                        help="Path of the config file.")
