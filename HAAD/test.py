...
model.load_state_dict(torch.load(work_dir+'/../DLWF_pytorch/trained_model/length_5000/llm_5000.pth'))
print_gpu_memory()


model2 = VarCNN(5000,100).to(device)
model2.load_state_dict(torch.load(work_dir+'/../DLWF_pytorch/trained_model/length_5000/varcnn_5000.pth'))
...
haad.verification_perturbation(model2,label=y_train,solution=best_combination)
